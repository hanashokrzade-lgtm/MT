...
import { Loader2, Sparkles, Volume2, Pause, User, Send, Mic, UserCircle2 } from 'lucide-react';
import {
 ...
 useEffect(() => {
  ...
  const handlePlayAudio = async (index: number) => {
    ...
    try {
        ...
        // After state update, play the audio
                                    ...
                                    <audio 
                                        ...
                                        onPause={() => {
                                            if (activeAudio?.index === index) {
                                                setActiveAudio(prevState => prevState && {...prevState, isPlaying: false});
                                            }
                                        }}
                                        className="hidden"
                                    />
